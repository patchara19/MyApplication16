...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener,LocationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lMng.requestLocationUpdates(LocationManager.GPS_PROVIDER,0,0,this);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (aa != null) {
            mMap.addPolyline(new PolylineOptions().add(aa).add(new LatLng(location.getLatitude(), location
                    .getLongitude())));
        }

        aa = new LatLng(location.getLatitude(),location
                .getLongitude());
